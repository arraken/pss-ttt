...
class Ui_CrewTrainer(object):
    def setupUi(self, CrewTrainer):
        ...
        self.trainingLevelBox = QComboBox(CrewTrainer)
        ...
        self.trainingLevelBox.addItem("")
        self.trainingLevelBox.addItem("")
        self.trainingLevelBox.setObjectName(u"trainingLevelBox")
        self.trainingLevelBox.setGeometry(QRect(10, 100, 81, 22))
    ...
    def retranslateUi(self, CrewTrainer):
        ...
        self.trainingLevelBox.setItemText(0, QCoreApplication.translate("CrewTrainer", u"Common", None))
        self.trainingLevelBox.setItemText(1, QCoreApplication.translate("CrewTrainer", u"Elite", None))
        self.trainingLevelBox.setItemText(2, QCoreApplication.translate("CrewTrainer", u"Unique", None))
        self.trainingLevelBox.setItemText(3, QCoreApplication.translate("CrewTrainer", u"Epic", None))
        self.trainingLevelBox.setItemText(4, QCoreApplication.translate("CrewTrainer", u"Hero", None))
        self.trainingLevelBox.setItemText(5, QCoreApplication.translate("CrewTrainer", u"Special", None))
        self.trainingLevelBox.setItemText(6, QCoreApplication.translate("CrewTrainer", u"Legendary", None))
        self.trainingLevelBox.setItemText(7, QCoreApplication.translate("CrewTrainer", u"Green", None))
        self.trainingLevelBox.setItemText(8, QCoreApplication.translate("CrewTrainer", u"Blue", None))
        self.trainingLevelBox.setItemText(9, QCoreApplication.translate("CrewTrainer", u"Gold", None))
        ...
        self.label_3.setText(QCoreApplication.translate("CrewTrainer", u"Training/Cons", None))

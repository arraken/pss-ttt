...
class Ui_starTargetTracking(object):
    def setupUi(self, starTargetTracking):
        ...
        self.playerNameSTTBox.setTabChangesFocus(True)
        ...
        self.fleetNameSTTBox.setTabChangesFocus(True)
        ...
        self.lastStarsSTTBox.setTabChangesFocus(True)
        ...
        self.maxTrophiesSTTBox.setTabChangesFocus(True)
        ...
        QWidget.setTabOrder(self.dayFourAdd, self.dayFourRemove)
        QWidget.setTabOrder(self.dayFourRemove, self.dayFourCopy)
        QWidget.setTabOrder(self.dayFourCopy, self.dayFiveAdd)
        QWidget.setTabOrder(self.dayFiveAdd, self.dayFiveRemove)
        QWidget.setTabOrder(self.dayFiveRemove, self.dayFiveCopy)
        QWidget.setTabOrder(self.dayFiveCopy, self.daySixAdd)
        QWidget.setTabOrder(self.daySixAdd, self.daySixRemove)
        QWidget.setTabOrder(self.daySixRemove, self.daySixCopy)
        QWidget.setTabOrder(self.daySixCopy, self.daySevenAdd)
        QWidget.setTabOrder(self.daySevenAdd, self.daySevenRemove)
        QWidget.setTabOrder(self.daySevenRemove, self.daySevenCopy)
        QWidget.setTabOrder(self.daySevenCopy, self.trackerResetButton)
        QWidget.setTabOrder(self.trackerResetButton, self.dayFiveTable)
        QWidget.setTabOrder(self.dayFiveTable, self.daySixTable)
        QWidget.setTabOrder(self.daySixTable, self.daySevenTable)
        QWidget.setTabOrder(self.daySevenTable, self.playerNameSTTBox)
        QWidget.setTabOrder(self.playerNameSTTBox, self.fleetNameSTTBox)
        QWidget.setTabOrder(self.fleetNameSTTBox, self.lastStarsSTTBox)
        QWidget.setTabOrder(self.lastStarsSTTBox, self.maxTrophiesSTTBox)
        QWidget.setTabOrder(self.maxTrophiesSTTBox, self.dayFourTable)
